# 3-Week Practical Preparation Schedule

## Week 1: Understand the Role and Build the Scenario
...
| 6 | Draft the current-state architecture and operations checklist |
| 7 | Rehearse a 5-minute explanation of why this is secure evidence-systems leadership |

## Week 2: Build the Technical Work Sample

| Day | Work |
| --- | --- |
| 8 | Review `sql/schema.sql` and explain each table in plain English |
| 9 | Practice the queries in `sql/analysis_queries.sql`; connect each query to a real investigative question |
| 10 | Prepare the migration plan and risk register |
| 11 | Prepare the data protection decision tree and DPIA triggers |
| 12 | Prepare the AI pilot evaluation answer |
| 13 | Create a one-page training narrative for investigators and CSO partners |
| 14 | Rehearse a 10-minute walkthrough of the full work sample |

## Week 3: Interview Simulation

| Day | Work |
| --- | --- |
| 15 | Run the 45-minute panel simulation aloud and record weak answers |
